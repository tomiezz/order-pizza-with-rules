...
import { ProductDataViewProps } from "../types";
    ...
    <Grid container flexDirection="column" mb={5}>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item md={7} sm={12}>
          ...
          <Typography my={1}>{description}</Typography>
          <Box
            my={1}
            py={2}
            pl={2}
            bgcolor={COLOR.GRAY_BACKGROUND}
            borderRadius={1}
          >
            <Typography variant="h5" color={COLOR.SECONDARY} fontWeight="bold">
              {price}$
            </Typography>
          </Box>
          <Box my={4}>
      ...
      <Grid mt={3}>
        <Typography>
          ...
          Aldus PageMaker including versions of Lorem Ipsum. <br /> Why do we
          use it? <br /> It is a long established fact that a reader will be
          ...
          humour and the like). <br /> Where does it come from? <br /> Contrary
...
export default memo(ProductDataView);
